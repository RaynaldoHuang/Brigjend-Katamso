        ...
        <nav class="wrapper">
            <ul class=" m-0 text-start">
                ...
                <li class="list-group-item border-bottom"><a href=""
                        ...
                        Kami</a></li>
                <li class="list-group-item"><a href="" class="text-white text-decoration-none">Kontak</a>
                </li>
            </ul>
        </nav>
    </div>
        ...
        <nav class="wrapper">
            <ul class=" m-0 text-start">
                <li class="list-group-item text-white mb-3">
                    ...
                    <div class="fw-normal">+62 098 1233</div>
                </li>
                <li class="list-group-item text-white mb-3">
        ...
        <nav class="wrapper">
            <ul class=" m-0 text-start">
                ...
                <li class="list-group-item text-white mb-3">
                    ...
                    <div class="fw-normal">contact@ypnbrigjendkatamso.sch.id</div>
                </li>
                <li class="list-group-item text-white mb-3">
                    ...
                    <div class="mt-5">
                        <a href=""><i class="fa-brands fa-instagram text-white fa-3x me-2"></i></a>
                        <a href=""><i class="fa-brands fa-square-facebook text-white fa-3x me-2"></i></a>
                        <a href=""><i class="fa-brands fa-youtube text-white fa-3x"></i></a>
                    </div>
                </li>
            </ul>
        </nav>
